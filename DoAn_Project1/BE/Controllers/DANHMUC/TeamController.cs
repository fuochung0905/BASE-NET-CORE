...
namespace BE.Controllers.DANHMUC
{
    ...
    public class TeamController : ControllerBase
    {
        ...
        public IActionResult Insert(PostTeamRequest request)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        public IActionResult Update(PostTeamRequest request)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        public IActionResult GetAllForComboboxOfMonHoc(GetByIdRequest request)
        {
            try
            {
                ...
                var result = _service.GetAllForComboboxWithMonHoc(request);
                if (result.Error)
                {
                    throw new Exception(result.Message);
                }
