...
using REPONSITORY.DANHMUC.GIAIDOANDUAN;

namespace BE.Controllers.DANHMUC;

[Route("api/[controller]")]
[ApiController]
public class GiaiDoanDuAnController : ControllerBase
{
	IGIAIDOANDUANService _service;

	public GiaiDoanDuAnController(IGIAIDOANDUANService service)
	{
		_service = service;
	}
    ...
    public IActionResult Insert(PostGiaiDoanDuAnRequest request)
	{
		try
		{
			if(!ModelState.IsValid)
    ...
    public IActionResult Update(PostGiaiDoanDuAnRequest request)
	{
		try
		{
			if(!ModelState.IsValid)
