...
using Service.DANHMUC.NIENKHOA;
...
namespace BE.Controllers.DANHMUC
{
    ...
    {
        INIENKHOAService _service;

        public NienKhoaController(INIENKHOAService service)
        {
            _service = service;
        }
        ...
        public IActionResult Insert(PostNienKhoaRequest request)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        public IActionResult Update(PostNienKhoaRequest request)
        {
            try
            {
                if (!ModelState.IsValid)
