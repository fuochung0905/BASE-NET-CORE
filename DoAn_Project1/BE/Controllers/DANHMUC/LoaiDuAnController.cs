...
using Service.DANHMUC.LOAIDUAN;
...
namespace BE.Controllers.DANHMUC
{
    ...
    [ApiController]
    public class LoaiDuAnController : ControllerBase
    {
        ILOAIDUANService _service;

        public LoaiDuAnController(ILOAIDUANService service)
        {
            _service = service;
        }
        ...
        public IActionResult Insert(PostLoaiDuAnRequest request)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        public IActionResult Update(PostLoaiDuAnRequest request)
        {
            try
            {
                if (!ModelState.IsValid)
